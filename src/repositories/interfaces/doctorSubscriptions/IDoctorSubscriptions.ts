...
export default interface IDoctorSubscriptionsRepository extends IBaseRepository<IDoctorSubscription>{
    ...
    findSubscriptionById(susbscriptionID:string):Promise<IDoctorSubscription|null>
