...
interface IAdminDashboardRepository {
    ...
    getMostSubscribedPlans(limit?: number): Promise<{ planName: string; subscriptionCount: number }[]>
    getRevenueTrend(
        startDate: Date,
        endDate: Date,
    ...
    getSubscriptionsForReport(startDate?: Date, endDate?: Date): Promise<IDoctorSubscriptionPopulated[]>

    getDoctorAnalyticsSummary(): Promise<any[]>
    getDoctorRevenueTrend(startDate: Date, endDate: Date, interval: "day" | "month"): Promise<any[]>
