...
import Services, { IDoctorService } from "../../../model/doctorService/doctorServicesModal";
import { BaseRepository } from "../../base/BaseRepository";
import IDoctorServiceRepository from "../../interfaces/doctorService/IDoctorServiceRepository";


class DoctorServiceRepository extends BaseRepository<IDoctorService> implements IDoctorServiceRepository{

    constructor(){
        super(Services)
    }
   
    createDoctorService(serviceData: Partial<IDoctorService>): Promise<IDoctorService> {
    ...
    async updateService(serviceId: string, updateData: Partial<IDoctorService>): Promise<IDoctorService | null> {
        try {
