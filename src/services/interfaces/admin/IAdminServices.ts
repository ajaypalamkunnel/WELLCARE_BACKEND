...
export interface IAdminService{
   ...
   fetchAllDoctors(page: number, limit: number, searchTerm?: string,filters?:DoctorFilter):Promise<{ data: IDoctor[]; total: number }>
   getAllUsers(page: number, limit: number,searchTerm?: string):Promise<{users:IUser[],totalUsers:number|null}>
