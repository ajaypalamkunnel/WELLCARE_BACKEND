...
interface IAdminDashboardService{
    ...
    getRevenueTrend(
      ...
      getPlanDistribution(startDate?: Date, endDate?: Date): Promise<PlanDistributionDTO[]>
      ...
      getDoctorRevenueTrend(startDate: Date, endDate: Date, interval: "day" | "month"): Promise<RevenueDoctorTrendDTO[]>
