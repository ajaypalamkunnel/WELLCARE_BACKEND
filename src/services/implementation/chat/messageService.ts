    ...
    async sendMessage(
        ...
        try {
            ...
            if (error instanceof CustomError) {
                ...
                throw new CustomError("Error in send message service", StatusCode.INTERNAL_SERVER_ERROR);
            }
        }
    }

    async getChatHistory(userId1: Types.ObjectId, userId2: Types.ObjectId): Promise<IMessage[]> {
        try {

            return await this._messageRepository.getMessagesBetweenUsers(userId1, userId2)
