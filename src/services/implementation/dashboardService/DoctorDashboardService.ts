...
class DoctorDashboardService implements IDoctorDashboardService {
    ...
    async getAppointmentSummary(
        ...
        try {
            return await this._dashboardRepo.getAppointmentStatusSummary(
                doctorId,
                startDate,
                endDate
            );
    ...
    async getAppointmentTrendData(
        ...
        try {
            if (!doctorId || !startDate || !endDate) {
                throw new CustomError(
                    "Invalid input for trend data",
                    StatusCode.BAD_REQUEST
                );
            }

            return await this._dashboardRepo.getAppointmentTrend(
                doctorId,
                startDate,
                endDate,
                interval
    ...
    async getRevenueStatistics(
        ...
        try {
            return await this._dashboardRepo.getRevenueTrend(
                doctorId,
                startDate,
                endDate,
                interval
    ...
    async generateReport(
        ...
        try {
            const appointments = await this._dashboardRepo.getAppointmentsForReport(
                doctorId,
                startDate,
                endDate
            );
    ...
    async getTopServices(
        ...
        try {
            ...
            return await this._dashboardRepo.getTopServices(
                doctorId,
                startDate,
                endDate
            );
