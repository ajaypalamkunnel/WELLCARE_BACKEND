...
const consultationBookingService = new ConsultationBookingService(
...
const consultationBookingController = new ConsultationBookingController(
...
router.post("/signup/basic_details", (req, res) =>
    userController.registerBasicDetails(req, res)
);
router.post("/signup/resend_otp", async (req, res) => {
    await userController.resendOtp(req, res);
});
router.post("/signup/verify_otp", async (req, res) => {
...
router.get("/get-all-active-departments", async (req, res) => {
    await departmentController.getAllActiveDepartments(req, res);
});
