...
const doctorSubscriptionService = new DoctorSubscriptionService(
    doctorSubscriptionRepository,
    subscriptionRepository,
    doctorRepository
);
const doctorSubscriptionController = new DoctorSubscriptionController(
    doctorSubscriptionService
);

const doctorServiceRepository = new DoctorServiceRepository();
const doctorServiceService = new DoctorServiceService(
    doctorServiceRepository,
    doctorRepository,
    doctorSubscriptionRepository
);
const doctorServiceController = new DoctorServiceController(
...
const consultationAppointmentService = new ConsultationBookingService(
    consultationAppointmentRepository,
    doctorScheduleRepository,
    doctorServiceRepository,
    walletRepository,
    walletService,
...
const consultationAppointmentController = new ConsultationBookingController(
    consultationAppointmentService
);
...
router.post("/signup/basic_details", (req, res) =>
    doctorController.registerBasicDetails(req, res)
);
router.post("/signup/resend_otp", async (req, res) => {
    await doctorController.resendOtp(req, res);
});
router.post("/signup/verify_otp", (req, res) =>
...
router.post(
    "/logout",
    async (req, res) => await doctorController.logoutDoctor(req, res)
);
router.post("/forgot-password", (req, res) =>
    doctorController.forgotPasswordDoctor(req, res)
);
...
router.post(
    ...
    checkDoctorBlocked,
    checkRole(Roles.DOCTOR),
    (req, res) => doctorController.registerDoctor(req, res)
);
router.put(
    "/updatestatus",
    authMiddleWare,
    checkRole(Roles.DOCTOR),
    (req, res) => doctorController.updateDoctorStatus(req, res)
);
router.put("/verify-doctor", authMiddleWare, (req, res) =>
    doctorController.verifyDoctor(req, res)
);
router.put(
...
router.get(
    "/get-my-subscription/:subscriptionId",
    authMiddleWare,
    checkDoctorBlocked,
    checkRole(Roles.DOCTOR),
    async (req, res) => {
...
router.get(
    ...
    checkRole(Roles.DOCTOR),
    async (req, res) => {
        await consultationAppointmentController.getAppointmentDetailForDoctor(
            req,
            res
        );
    }
...
router.get(
    "/fetch-prescription/:appointmentId",
    authMiddleWare,
    checkRole(Roles.DOCTOR),
    async (req, res) => {
